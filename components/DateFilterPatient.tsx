    ...
    <div className="flex flex-col sm:flex-row gap-4">
      <Popover>
        <PopoverTrigger asChild>
          <span
            className={cn(
              "flex items-center cursor-pointer gap-2 w-[190px] text-white/50 justify-start text-left font-normal p-2 bg-dark-400 border border-dark-500 rounded",
...
export default DateFilterPatient;
