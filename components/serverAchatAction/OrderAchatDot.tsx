...
const OrderAchatDot = ({ data }: { data: ServerSell }) => {
  return (
    <div>
      <DropdownMenu>
        ...
        >
          ...
          <DropdownMenuItem
            ...
            onClick={() => {
              navigator.clipboard.writeText(String(data.serverPriceDh));
              toast.success("Prix du serveur copié dans la presse papier", {
                style: {
                  color: "#22c55e",
                  background: "#0D0F10",
